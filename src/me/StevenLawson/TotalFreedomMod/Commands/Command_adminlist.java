...
public class Command_adminlist extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        sender.sendMessage(" ");
        //sender.sendMessage(ChatColor.DARK_RED + "Executives: ");
        sender.sendMessage(ChatColor.DARK_RED + "System Admins: samennis1, KM_Galahad");
        sender.sendMessage(ChatColor.DARK_PURPLE + "Developers: AwesomePinch, AndySixx, Savnith, tylerhyperHD, OxLemonxO");
